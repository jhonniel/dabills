...
- After schema changes, apply migrations 001–013 in order
- With Supabase configured, data lives in the database (not browser cookies); cookies are demo-only when Supabase env is missing
